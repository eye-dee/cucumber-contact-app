...
public enum CucumberTestContext {
    ...
    private static final String LAST_SUCCESS_RESPONSE = "LAST_SUCCESS_RESPONSE";
    ...
    public void setLastSuccessResponse(Response response) {
        set(LAST_SUCCESS_RESPONSE, response);
    }

    public Response getLastSuccessResponse() {
        return get(LAST_SUCCESS_RESPONSE, Response.class);
    }
